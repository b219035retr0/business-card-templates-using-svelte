    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t43 = space();
    			img6 = element("img");
    			attr_dev(h30, "class", "svelte-bo7pl9");
    			add_location(h30, file, 396, 3, 7220);
    			attr_dev(label0, "for", "name");
    			attr_dev(label0, "class", "svelte-bo7pl9");
    			add_location(label0, file, 398, 2, 7281);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "name");
    			attr_dev(input0, "placeholder", "Your Name");
    			attr_dev(input0, "class", "svelte-bo7pl9");
    			add_location(input0, file, 399, 2, 7316);
    			attr_dev(div0, "class", "form-group svelte-bo7pl9");
    			add_location(div0, file, 397, 3, 7253);
    			attr_dev(label1, "for", "designation");
    			attr_dev(label1, "class", "svelte-bo7pl9");
    			add_location(label1, file, 402, 2, 7442);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "designation");
    			attr_dev(input1, "placeholder", "Your Designation");
    			attr_dev(input1, "class", "svelte-bo7pl9");
    			add_location(input1, file, 403, 2, 7491);
    			attr_dev(div1, "class", "form-group svelte-bo7pl9");
    			add_location(div1, file, 401, 3, 7414);
    			attr_dev(label2, "for", "address");
    			attr_dev(label2, "class", "svelte-bo7pl9");
    			add_location(label2, file, 406, 2, 7638);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "id", "address");
    			attr_dev(input2, "placeholder", "Your Address");
    			attr_dev(input2, "class", "svelte-bo7pl9");
    			add_location(input2, file, 407, 2, 7679);
    			attr_dev(div2, "class", "form-group svelte-bo7pl9");
    			add_location(div2, file, 405, 3, 7610);
    			attr_dev(label3, "for", "phoneNumber");
    			attr_dev(label3, "class", "svelte-bo7pl9");
    			add_location(label3, file, 410, 2, 7814);
    			attr_dev(input3, "type", "text");
    			attr_dev(input3, "id", "phoneNumber");
    			attr_dev(input3, "placeholder", "Your Phone Number with Country Code");
    			attr_dev(input3, "class", "svelte-bo7pl9");
    			add_location(input3, file, 411, 2, 7864);
    			attr_dev(div3, "class", "form-group svelte-bo7pl9");
    			add_location(div3, file, 409, 3, 7786);
    			attr_dev(label4, "for", "website");
    			attr_dev(label4, "class", "svelte-bo7pl9");
    			add_location(label4, file, 414, 2, 8030);
    			attr_dev(input4, "type", "text");
    			attr_dev(input4, "id", "website");
    			attr_dev(input4, "placeholder", "Your Website");
    			attr_dev(input4, "class", "svelte-bo7pl9");
    			add_location(input4, file, 415, 2, 8071);
    			attr_dev(div4, "class", "form-group svelte-bo7pl9");
    			add_location(div4, file, 413, 3, 8002);
    			attr_dev(button, "class", "svelte-bo7pl9");
    			add_location(button, file, 418, 2, 8210);
    			attr_dev(div5, "class", "button-section svelte-bo7pl9");
    			add_location(div5, file, 417, 3, 8178);
    			attr_dev(div6, "class", "input-section svelte-bo7pl9");
    			add_location(div6, file, 395, 1, 7188);
    			attr_dev(h31, "class", "svelte-bo7pl9");
    			add_location(h31, file, 423, 2, 8315);
    			attr_dev(img0, "class", "icon svelte-bo7pl9");
    			attr_dev(img0, "alt", "");
    			...
    			add_location(img0, file, 427, 4, 8455);
    			attr_dev(section0, "class", "frame svelte-bo7pl9");
    			add_location(section0, file, 426, 5, 8426);
    			attr_dev(img1, "class", "icon1 svelte-bo7pl9");
    			attr_dev(img1, "alt", "");
    			...
    			add_location(img1, file, 432, 5, 8677);
    			attr_dev(div7, "class", "frame3 svelte-bo7pl9");
    			add_location(div7, file, 431, 6, 8650);
    			attr_dev(p0, "class", "fauget svelte-bo7pl9");
    			add_location(p0, file, 436, 7, 8895);
    			attr_dev(p1, "class", "real-estate svelte-bo7pl9");
    			add_location(p1, file, 437, 7, 8941);
    			attr_dev(div8, "class", "fauget-real-estate-container svelte-bo7pl9");
    			add_location(div8, file, 435, 5, 8844);
    			attr_dev(div9, "class", "frame4 svelte-bo7pl9");
    			add_location(div9, file, 434, 6, 8817);
    			attr_dev(div10, "class", "frame2 svelte-bo7pl9");
    			add_location(div10, file, 430, 4, 8622);
    			attr_dev(div11, "class", "frame1 svelte-bo7pl9");
    			add_location(div11, file, 429, 5, 8596);
    			attr_dev(div12, "class", "front17 svelte-bo7pl9");
    			attr_dev(div12, "id", "frontContainer");
    			add_location(div12, file, 425, 4, 8378);
    			attr_dev(div13, "class", "business-card-front svelte-bo7pl9");
    			add_location(div13, file, 424, 2, 8339);
    			attr_dev(h32, "class", "svelte-bo7pl9");
    			add_location(h32, file, 445, 2, 9071);
    			attr_dev(p2, "class", "john-leopard svelte-bo7pl9");
    			add_location(p2, file, 451, 5, 9316);
    			attr_dev(p3, "class", "real-estate-agent svelte-bo7pl9");
    			add_location(p3, file, 452, 5, 9366);
    			attr_dev(div14, "class", "john-leopard-real-container svelte-bo7pl9");
    			add_location(div14, file, 450, 6, 9268);
    			attr_dev(img2, "class", "frame-icon svelte-bo7pl9");
    			attr_dev(img2, "alt", "");
    			...
    			add_location(img2, file, 454, 6, 9443);
    			attr_dev(div15, "class", "john-leopard-real-estate-agent-parent svelte-bo7pl9");
    			add_location(div15, file, 449, 4, 9209);
    			attr_dev(img3, "class", "icon2 svelte-bo7pl9");
    			attr_dev(img3, "alt", "");
    			...
    			add_location(img3, file, 456, 4, 9584);
    			attr_dev(div16, "class", "frame-child svelte-bo7pl9");
    			add_location(div16, file, 459, 4, 9723);
    			attr_dev(div17, "class", "div svelte-bo7pl9");
    			add_location(div17, file, 461, 6, 9788);
    			attr_dev(div18, "class", "div svelte-bo7pl9");
    			add_location(div18, file, 462, 6, 9841);
    			attr_dev(div19, "class", "div svelte-bo7pl9");
    			add_location(div19, file, 463, 6, 9890);
    			attr_dev(div20, "class", "frame6 svelte-bo7pl9");
    			add_location(div20, file, 460, 4, 9760);
    			attr_dev(img4, "class", "frame-icon1 svelte-bo7pl9");
    			attr_dev(img4, "alt", "");
    			...
    			add_location(img4, file, 466, 6, 9977);
    			attr_dev(img5, "class", "frame-icon2 svelte-bo7pl9");
    			attr_dev(img5, "alt", "");
    			...
    			add_location(img5, file, 469, 6, 10124);
    			attr_dev(img6, "class", "frame-icon3 svelte-bo7pl9");
    			attr_dev(img6, "alt", "");
    			...
    			add_location(img6, file, 472, 6, 10272);
    			attr_dev(div21, "class", "frame7 svelte-bo7pl9");
    			add_location(div21, file, 465, 4, 9949);
    			attr_dev(section1, "class", "frame5 svelte-bo7pl9");
    			add_location(section1, file, 448, 5, 9179);
    			attr_dev(div22, "class", "back svelte-bo7pl9");
    			attr_dev(div22, "id", "backContainer");
    			add_location(div22, file, 447, 4, 9135);
    			attr_dev(div23, "class", "business-card-back svelte-bo7pl9");
    			add_location(div23, file, 446, 2, 9097);
    			attr_dev(div24, "class", "preview-section svelte-bo7pl9");
    			add_location(div24, file, 422, 1, 8282);
    			attr_dev(div25, "class", "business-card-container svelte-bo7pl9");
    			add_location(div25, file, 394, 2, 7148);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(394:2) {#if currentPage === \\\"home\\\"}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file, 484, 3, 10563);
    			add_location(h30, file, 485, 3, 10590);
    			attr_dev(img0, "class", "icon svelte-bo7pl9");
    			attr_dev(img0, "alt", "");
    			if (!src_url_equal(img0.src, img0_src_value = "C:\\Users\\Sayalee\\Downloads\\GIt-Hub\\svelte-app\\module-4\\template-card17\\public\\a.png")) attr_dev(img0, "src", img0_src_value);
    			add_location(img0, file, 489, 4, 10730);
    			attr_dev(section0, "class", "frame svelte-bo7pl9");
    			add_location(section0, file, 488, 5, 10701);
    			attr_dev(img1, "class", "icon1 svelte-bo7pl9");
    			attr_dev(img1, "alt", "");
    			if (!src_url_equal(img1.src, img1_src_value = "C:\\Users\\Sayalee\\Downloads\\GIt-Hub\\svelte-app\\module-4\\template-card17\\public\\b.png")) attr_dev(img1, "src", img1_src_value);
    			add_location(img1, file, 494, 5, 10952);
    			attr_dev(div0, "class", "frame3 svelte-bo7pl9");
    			add_location(div0, file, 493, 6, 10925);
    			attr_dev(p1, "class", "fauget svelte-bo7pl9");
    			add_location(p1, file, 498, 7, 11170);
    			attr_dev(p2, "class", "real-estate svelte-bo7pl9");
    			add_location(p2, file, 499, 7, 11216);
    			attr_dev(div1, "class", "fauget-real-estate-container svelte-bo7pl9");
    			add_location(div1, file, 497, 5, 11119);
    			attr_dev(div2, "class", "frame4 svelte-bo7pl9");
    			add_location(div2, file, 496, 6, 11092);
    			attr_dev(div3, "class", "frame2 svelte-bo7pl9");
    			add_location(div3, file, 492, 4, 10897);
    			attr_dev(div4, "class", "frame1 svelte-bo7pl9");
    			add_location(div4, file, 491, 5, 10871);
    			attr_dev(div5, "class", "front17 svelte-bo7pl9");
    			attr_dev(div5, "id", "frontContainer");
    			add_location(div5, file, 487, 4, 10653);
    			attr_dev(div6, "class", "business-card-front svelte-bo7pl9");
    			add_location(div6, file, 486, 2, 10614);
    			add_location(h31, file, 507, 2, 11346);
    			attr_dev(p3, "class", "john-leopard svelte-bo7pl9");
    			add_location(p3, file, 513, 5, 11591);
    			attr_dev(p4, "class", "real-estate-agent svelte-bo7pl9");
    			add_location(p4, file, 514, 5, 11641);
    			attr_dev(div7, "class", "john-leopard-real-container svelte-bo7pl9");
    			add_location(div7, file, 512, 6, 11543);
    			attr_dev(img2, "class", "frame-icon svelte-bo7pl9");
    			attr_dev(img2, "alt", "");
    			if (!src_url_equal(img2.src, img2_src_value = "C:\\Users\\Sayalee\\Downloads\\GIt-Hub\\svelte-app\\module-4\\template-card17\\public\\a.png")) attr_dev(img2, "src", img2_src_value);
    			add_location(img2, file, 516, 6, 11718);
    			attr_dev(div8, "class", "john-leopard-real-estate-agent-parent svelte-bo7pl9");
    			add_location(div8, file, 511, 4, 11484);
    			attr_dev(img3, "class", "icon2 svelte-bo7pl9");
    			attr_dev(img3, "alt", "");
    			if (!src_url_equal(img3.src, img3_src_value = "C:\\Users\\Sayalee\\Downloads\\GIt-Hub\\svelte-app\\module-4\\template-card17\\public\\left.png")) attr_dev(img3, "src", img3_src_value);
    			add_location(img3, file, 518, 4, 11859);
    			attr_dev(div9, "class", "frame-child svelte-bo7pl9");
    			add_location(div9, file, 521, 4, 11998);
    			attr_dev(div10, "class", "div svelte-bo7pl9");
    			add_location(div10, file, 523, 6, 12063);
    			attr_dev(div11, "class", "div svelte-bo7pl9");
    			add_location(div11, file, 524, 6, 12116);
    			attr_dev(div12, "class", "div svelte-bo7pl9");
    			add_location(div12, file, 525, 6, 12165);
    			attr_dev(div13, "class", "frame6 svelte-bo7pl9");
    			add_location(div13, file, 522, 4, 12035);
    			attr_dev(img4, "class", "frame-icon1 svelte-bo7pl9");
    			attr_dev(img4, "alt", "");
    			if (!src_url_equal(img4.src, img4_src_value = "C:\\Users\\Sayalee\\Downloads\\GIt-Hub\\svelte-app\\module-4\\template-card17\\public\\zero.png")) attr_dev(img4, "src", img4_src_value);
    			add_location(img4, file, 528, 6, 12252);
    			attr_dev(img5, "class", "frame-icon2 svelte-bo7pl9");
    			attr_dev(img5, "alt", "");
    			if (!src_url_equal(img5.src, img5_src_value = "C:\\Users\\Sayalee\\Downloads\\GIt-Hub\\svelte-app\\module-4\\template-card17\\public\\first.png")) attr_dev(img5, "src", img5_src_value);
    			add_location(img5, file, 531, 6, 12399);
    			attr_dev(img6, "class", "frame-icon3 svelte-bo7pl9");
    			attr_dev(img6, "alt", "");
    			if (!src_url_equal(img6.src, img6_src_value = "C:\\Users\\Sayalee\\Downloads\\GIt-Hub\\svelte-app\\module-4\\template-card17\\public\\second.png")) attr_dev(img6, "src", img6_src_value);
    			add_location(img6, file, 534, 6, 12547);
    			attr_dev(div14, "class", "frame7 svelte-bo7pl9");
    			add_location(div14, file, 527, 4, 12224);
    			attr_dev(section1, "class", "frame5 svelte-bo7pl9");
    			add_location(section1, file, 510, 5, 11454);
    			attr_dev(div15, "class", "back svelte-bo7pl9");
    			attr_dev(div15, "id", "backContainer");
    			add_location(div15, file, 509, 4, 11410);
    			attr_dev(div16, "class", "business-card-back svelte-bo7pl9");
    			add_location(div16, file, 508, 2, 11372);
    			add_location(button, file, 539, 3, 12731);
    			attr_dev(div17, "class", "prompt-content svelte-bo7pl9");
    			add_location(div17, file, 483, 1, 10530);
    			attr_dev(div18, "class", "prompt svelte-bo7pl9");
    			add_location(div18, file, 482, 2, 10507);
    		},
    		m: function mount(target, anchor) {
